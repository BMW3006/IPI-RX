# server.py - IPI-RX Link Tracker Pro (15 Features)
# Dynamic Link Generator + Full Visitor Info
...
def home():
    ...
    link_url = f"http://localhost:5000/track/{link_id}"
    ...
    <body>
        <div class="box">
            ...
            <div class="footer">15 Features • Dynamic Links</div>
        </div>
...
def new_link():
    link_id = create_new_link()
    link = f"http://localhost:5000/track/{link_id}"
    return {"link": link}

# ============================================
# TRACKING - Shows 15 Features
# ============================================
